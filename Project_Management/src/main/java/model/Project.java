...
public String insertProject(String projectCode, String projectName, String researcherID, String projectDesc, String categoryID, String projectRemarks) 
 { 
    String output = ""; 
 ...
 { 
    ...
    preparedStmt.setString(6, categoryID); 
    preparedStmt.setString(7, projectRemarks); 
...
{ 
 ...
 { 
      ...
      String projectRemarks = rs.getString("projectRemarks");
      ...
      output += "<td>" + categoryID + "</td>";
      output += "<td>" + projectRemarks + "</td>";
...
public String updateProject(String projectID ,String projectCode, String projectName, String researcherID, String projectDesc, String categoryID, String projectRemarks)
 { 
   ...
   { 
     ...
     // create a prepared statement
     String query = "UPDATE projects SET projectCode=?,projectName=?,researcherID=?,projectDesc=?,categoryID=?,projectRemarks=?"
     		+ "      WHERE projectID=?"; 
     PreparedStatement preparedStmt = con.prepareStatement(query); 
     ...
     preparedStmt.setString(6, projectRemarks);  
